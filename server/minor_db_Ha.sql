...
(
    ...
    'Preparing the Ingredients: Slice the Chinese sausage. Slice the jicama, carrot, and herbs into thin strips. Beat the eggs and cook them in a pan until set. Then, slice them into thin strips. Soak the dried shrimp in warm water to soften them. Assembling the Bo Bia: Heat oil in a pan and cook the beaten eggs to make thin omelets. Soften the rice paper wrappers by dipping them in warm water. Lay out the softened wrapper on a clean surface. Layer the lettuce leaves, jicama, carrot, Chinese sausage, egg strips, dried shrimp, and herbs on the lower third of the wrapper. Fold the sides of the wrapper over the filling, then roll tightly to enclose the filling. Repeat the process with the remaining ingredients. Making the Dipping Sauce: Whisk together hoisin sauce, peanut butter, water, soy sauce, and rice vinegar until smooth to make the dipping sauce. Serving: Serve the Bo Bia with the dipping sauce on the side, sprinkled with sesame seeds.',
...
(
    ...
    'Prepare Meat: Clean pork leg, beef shank, and beef chuck. Boil in water until just covered. Remove from heat, discard water, and set meat aside. Prepare Aromatics: In the same pot, cook garlic, Bun Bo Hue powder, shrimp paste, and oil until fragrant. Add beef shank and chuck, brown on all sides. Simmer Broth: Add water to cover meat, onion, daikon, and lemongrass. Simmer for 2-3 hours. Remove meat when tender. Season Broth: Add salt, fish sauce, sugar, and chicken broth. Simmer for 15 minutes. Prepare Sate Chili: Cook annatto seeds in oil until red. Discard seeds, then cook remaining chili ingredients. Combine: Add sate chili to broth. Adjust seasoning if needed. Assemble Bowls: Place cooked noodles in bowls, top with beef slices, pork hock, cilantro, green onions, bean sprouts, cha lua, and shrimp paste. Ladle soup over ingredients and serve.',
