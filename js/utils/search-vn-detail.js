document.addEventListener('DOMContentLoaded', function() {
    ...
    document
        .getElementById("search-button-icon-vn-detail")
        .addEventListener("click", function() {
            const searchBox = document.querySelector(".search-box-vn-detail");
            const searchInput = document.getElementById("search-input-vn-detail");
    ...
    document.addEventListener("click", function(event) {
        if (event.target && event.target.id === "search-button-icon-vn-detail") {
            handleSearch();
        }
    });
    ...
    const displaySearchResults = (searchResults) => {
        const searchResultsSection = document.getElementById("search-results-section-vn-detail");
        ...
        if (searchResults.length === 0) {
            ...
            searchResults.forEach((result, index) => {
                if (index % 3 === 0) {
                    ...
                    searchResultsSection.appendChild(rowDiv);
                }
